...
it('should be able to update across all indices', function () use (&$dataCheck) {
    ...
    $this->assertTrue(count($pageHits9) === 0, 'Failed: Count is '.count($pageHits9));
    $this->assertTrue(count($pageHits99) === $dataCheck['pagesIds'][9], 'Failed: Count is '.count($pageHits99).' and should be '.$dataCheck['pagesIds'][9]);
